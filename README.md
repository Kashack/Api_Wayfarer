...
Clone the repository: git clone https://github.com/Kashack/Api_Wayfarer.git in the folder you created

Install all dependencies by running the command: **npm istall**
